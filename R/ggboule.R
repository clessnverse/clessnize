...
#' Print ASCII portrait of JML
#'
#' This function prints an ASCII art portrait of our boss that fits nicely in the RStudio console.
#'
#' @return No return value, called for side effect (printing ASCII art)
#' @export
#'
#' @examples
#' jml()
