###########################################################
# Exemple d'utilisation du thème datagotchi_light avec patchwork
###########################################################
...
# 8. Appliquer le thème datagotchi light avec la police Pixel Operator à tout le graphique
final_plot_with_pixel <- apply_pixel_font(final_plot)

# 9. Sauvegarder
ggsave("musee_barplot_fr_example.png", 
       final_plot_with_pixel, 
       width = 16, 
       height = 8,
       dpi = 200,
       bg = "white")

# 10. Ajouter le logo CLESSN
...
add_logo_to_plot(final_plot_with_pixel, logo_path = logo_path, output_path = "musee_barplot_fr_example_with_logo.png")

# Afficher le résultat
# Normalement, on le verrait dans RStudio
cat("Graphiques créés avec succès! Vérifiez les fichiers 'musee_barplot_fr_example.png' et 'musee_barplot_fr_example_with_logo.png'.")